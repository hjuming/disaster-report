import { useState } from 'react' // <--- 移除了未使用的 useEffect
...
                2025年09月23日
              </Badge>
      _         <Badge variant="outline" className="text-sm">
...
          _         <div className="mt-4 space-y-3">
                      <p className="text-gray-700">
...
nbsp                   <td className="border border-gray-300 p-2">主要責任</td>
                        </tr>
                        <tr>
...
                <div>
              _   <h3 className="text-xl font-semibold mb-3">政治責任與災後卸責文化</h3>
                  <p className="text-gray-700 leading-relaxed">
...
          {/* Recommendations */}
        _ {activeSection === 'recommendations' && (
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
...
MS                   <p className="text-gray-600 text-sm">針對跨區域、複雜大型災害，授權中央直接調度指揮地方應變資源。（前國家災害防救科技中心主任 陳宏宇 博士，2025年09月26日研討會發言）</p>
                      </div>
        _         </li>
                  </ul>
                </div>
...
                      src={image8} 
                      alt="堰塞湖溢流沖毀橋梁" 
              _       className="w-full h-64 object-cover rounded-lg shadow-md"
                    />
                    <p className="text-sm text-gray-600 text-center">
...
NB     <div className="container mx-auto px-4 text-center">
          <div className="mb-6">
...
F         <p className="text-gray-500 text-sm">
